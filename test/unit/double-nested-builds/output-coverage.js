...
447(module, __unused_rspack_exports, __nccwpck_require__) {
/******/ (() => { // webpackBootstrap
/******/ 	var __webpack_modules__ = ({
...
/***/ ((module) => {
  ...
  (() => {
  __nccwpck_require3_.r(__nested_rspack_exports__);
  ...
  const file = __nccwpck_require3_.ab + "pi-bridge.js";
  
  const obscureRequire = eval(`function obscureRequire (file) {
      require(file);
  }`);
  
  console.log(obscureRequire(__nccwpck_require3_.ab + "pi-bridge.js"));
...
/******/ 	var __nested_rspack_exports__ = __nccwpck_require2_(332);
/******/ 	module.exports = __nested_rspack_exports__;
/******/ 	
/******/ })()
;
