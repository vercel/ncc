...
function ncc (
  ...
  if (esm && emitsCommonJsModule(tsCompilerOptions.module)) {
...
function emitsCommonJsModule(moduleKind) {
  return typeof moduleKind === 'string' && moduleKind.toLowerCase() === 'commonjs';
}
